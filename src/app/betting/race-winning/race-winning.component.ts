...
@Component({
  selector: 'app-race-winning',
  templateUrl: './race-winning.component.html',
  styleUrls: ['./race-winning.component.scss']
})
export class RaceWinningComponent implements OnInit {
